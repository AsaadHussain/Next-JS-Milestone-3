...
export default function Header() {
    return (
        <header className="flex border-b py-3 px-4 sm:px-10 bg-[#ffa228] font-[sans-serif] min-h-[65px] tracking-wide relative z-50">
            <div className="flex flex-wrap items-center gap-4 max-w-screen-xl mx-auto w-full">
                <Link href="/" className="max-sm:hidden text-white">
                    <Apple size={40} />
                </Link>
                <Link href="/" className="hidden max-sm:block text-white">
                    <Apple size={36} />
                </Link>
                <div
                    id="collapseMenu"
                ...
                >
                    ...
                    <ul className="lg:flex lg:ml-14 lg:gap-x-5 max-lg:space-y-3 max-lg:fixed max-lg:bg-white max-lg:w-1/2 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-6 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50">
                        ...
                        <li className="max-lg:border-b max-lg:py-3 px-3">
                            <Link
                                href="/"
                                className="lg:hover:text-[#007bff] text-[#ffffff] block text-[15px]"
                            >
                                Home
                            </Link>
                        </li>
                        <li className="max-lg:border-b max-lg:py-3 px-3">
                            <Link
                                href="/contactUs"
                                className="lg:hover:text-[#007bff] text-white block text-[15px]"
                            >
                                Contact Us
                            </Link>
                        </li>
